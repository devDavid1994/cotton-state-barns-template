...
<html lang="en">
    ...
    <body>
        ...
        <section class="section p-1 p-md-5">
            <div class="container">
                            ...
                            <div class="row gx-5">
                                <div class="col d-title">
                                    <p>
										...
										Normal wear or aging of any kind for any Cotton State Barns product, or any component of a Cotton State Barns product, which may include, but is not limited to, cosmetic changes in the appearance of wood, metal, paint, stain, sealant, glass, or other products which are not structural in nature.
                                    </p>
                                    <p>
                                        <i class="fa fa-check-square-o"></i>
                                    ...
                                    <p>
                                        <i class="fa fa-check-square-o"></i>
										Cotton State Barns is expressly not liable and accepts no responsibility in the event any of its products do not meet “expectations” that are not specifically related to defects in craftsmanship or materials.
									</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-5 border bg-light d-content">
                            ...
                            <div class="row gx-5">
                                <div class="col d-title-bar">
                                    ...
                                    <p>
										However, Cotton State Barns may sometimes warranty a Pre-Owned and/or Discounted Building for a period of up to six (6) years from the Serial Number date for the following:
                                    </p>
                                    <p>
                                    ...
                                    <p class="italic">
										*Discounted buildings are defined as any building, new or used, that was sold for less than what Cotton State Barn’s current retail pricing was at the time of sale.
                                    </p>
                                    <p class="italic">
                        ...
                        <div class="p-5 border d-content bg-green">
                            ...
                            <div class="row gx-5">
                                <div class="col d-title-bar">
									...
									<a href="https://zfrmz.com/3AVCJlrZ7fFHPt7lT9PQ" class="btn btn-style3 btn-extra-style mt-3 d-block mx-auto" target="_blank">SUBMIT A REPAIR REQUEST</a>
