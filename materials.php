<?php
	session_start();
	$title = 'Materials | Cotton State Barns';
?>
                            ...
                            <div class="full-banner">
                                <div class="banner-main">
                                    <a href="#" class="banner-hover img-hover">
                                        <img src="image/4D9A3096.png" class="img-fluid banner-bg-image" alt="banner-image">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-5 border bg-white d-content">
                            <div class="row gy-5 gx-5">
                                <div class="col-lg-12 col-xl-8 title">
                                    <h1>Customize Your&nbsp;<span class="text-green">Barn</span></h1>
                            ...
                            <div class="row gy-5 gx-5">
                                <div class="col gallery">
                                    ...
                                    <div class="row gx-2 gy-2 trim-gallery">
                                        ...
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim text-white" style="background: #92d1d0; border-color: #92d1d0;">BORA&nbsp;BORA</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                            ...
                            <div class="row gy-5 gx-5">
                                <div class="col gallery">
                                    ...
                                    <div class="row gx-2 gy-2 trim-gallery">
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image text-white" style="background-image: url(image/csb/URETHANE/Chestnut_Brown.jpg);">CHESTNUT BROWN</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image" style="background-image: url(image/csb/URETHANE/Driftwood_2-2.jpg);">DRIFTWOOD</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image text-white" style="background-image: url(image/csb/URETHANE/Red-Mahogany.jpg);">RED-MAHOGANY</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image text-white" style="background-image: url(image/csb/URETHANE/Honey_Gold.jpg);">HONEY GOLD</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row gy-5 gx-5">
                                <div class="col gallery">
                                    ...
                                    <div class="row gx-2 gy-2 trim-gallery">
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image text-white" style="background-image: url(image/csb/SHINGLES/Black_1.jpg)">BLACK</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image text-white" style="background-image: url(image/csb/SHINGLES/Ceder.jpg);">CEDAR</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image text-white" style="background-image: url(image/csb/SHINGLES/Weathered_Wood.jpg);">WEATHERED WOOD</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row gy-5 gx-5">
                                <div class="col gallery">
                                    ...
                                    <div class="row gx-2 gy-2 trim-gallery">
                                        ...
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim text-white" style="background: #3c3d2e; border-color: #3c3d2e;">BURNISHED SLATE</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                            ...
                            <div class="row gy-5 gx-5">
                                <div class="col gallery">
                                    ...
                                    <div class="row gx-2 gy-2 trim-gallery">
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image" style="background-image: url(image/csb/Siding/Stained_t1-11.jpg)">T1-11</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image" style="background-image: url(image/csb/Siding/Metal\ Siding.jpg);">METAL</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image" style="background-image: url(image/csb/Siding/LP\ Smart\ Siding.jpg);">LP SMART SIDING</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row gy-5 gx-5">
                                <div class="col gallery">
                                    ...
                                    <div class="row gx-2 gy-2 trim-gallery">
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image" style="background-image: url(image/csb/Flooring/Smooth\ Floor.jpg)">5/8" SMOOTH TONGUE AND GROOVE</div>
                                        </div>
                                        <div class="col-sm-3 col-md-4 col-lg-3 col-xl-2">
                                            <div class="trim trim-image" style="background-image: url(image/csb/Flooring/Treated\ Flooring.jpg);">5/8" TREATED PLYWOOD</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row gy-5 gx-5">
                                <div class="col description italic">
                                    *ACTUAL COLORS MAY VARY. See dealer for actual color samples. We are not responsible for matching colors
                                    from printed or digital images. Availability of options, colors, materials and finishes may vary by region.
                                    Ask your dealer for details and pricing.
                                </div>
                            </div>
                        </div>
                    </div>
